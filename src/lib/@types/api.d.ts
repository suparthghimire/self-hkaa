declare module "@api/types" {
	...
	export type T_AvatarHeads = {
		default: string;
		total: number;
		public: { [key: string]: T_Avatar };
	};
	export type T_PrefixUrlTypes = {
		prefix_original: string;
		prefix_images: string;
		prefix_videos: string;
		prefix_audio: string;
		prefix_models: string;
	};
	export type T_PrefixUrl = {
		urlprefix: {
			roomassets: T_PrefixUrlTypes;
			saskey: string;
		};
	};
	export type T_RoomUsers = {
		worldName: string;
		activeUsers: number;
		totalUsers: number;
	}[];
